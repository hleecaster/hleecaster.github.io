...
> 마이다스아이티 채용솔루션 공식 홈페이지 (midashri.com)

이 글이 인용하는 마이다스아이티 공식 홈페이지와 FAQ는 현재 사이트가 폐쇄되어 접속되지 않는다. 아래 인용문은 2020년 작성 당시의 내용이다.
...
- “AI 역량검사의 정확도와 타당도는 신뢰할 수 있는 수준인가요? 그리고 정확도 및 타당도 판단 기준과 이를 뒷받침할 실제 통계 수치가 궁금합니다”
