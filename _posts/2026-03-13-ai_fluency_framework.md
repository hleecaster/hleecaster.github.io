...
> Anthropic Academy에서 무료로 제공하는
> [AI Fluency: Framework & Foundations](https://anthropic.skilljar.com/ai-fluency-framework-foundations) 코스의 내용 정리 
...
단순히 프롬프트를 잘 쓰는 기술이 아니라, 실용적 기술(skills), 지식(knowledge), 통찰(insights), 가치관(values)을 모두 포괄하는 종합적인 역량이다.
