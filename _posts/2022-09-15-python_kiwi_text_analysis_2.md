---
title: 파이썬 형태소분석기 Kiwi를 활용한 텍스트 분석 – (2) 동시출현 단어 & 네트워크 시각화
date: 2022-09-15
categories: [WORK, Data]
tags: [Python, 데이터분석, 데이터시각화]
---

이번에는 파이썬 Kiwi로 형태소 분석 수행 후에 동시 출현 (Co-occurence) 단어 행렬을 만들어보고, 이를 네트워크 형태로 시각화 하는 코드 예시.

목차 다음과 같음.

- pandas 데이터프레임에서 kiwi 형태소 분석 수행
